...
namespace NetChat2.Models
{
    ...
    public class MessageViewModel : ObservableObject, IReadable
    {
        ...
        public MessageViewModel(DateTime dateTime, User user, string text, bool isOriginNative = false, bool isReaded = false)
        {
            _dateTime = dateTime;
            _user = user;
            _text = text;
