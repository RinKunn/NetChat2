...
{
    //public delegate void NewMessageReceivedHandler(TextMessageViewModel message);
    ...
    //    Task<IEnumerable<TextMessageViewModel>> LoadAllMessages(int count = 0);
    //}
    ...
    //    private readonly IMessageFileNotifier _hub;
    //    private readonly User _user;

    //    public ChatService(IMessageFileNotifier hub, User user)
    //    {
    //        _user = user;
    ...
    //    public async Task<IEnumerable<TextMessageViewModel>> LoadAllMessages(int count = 0)
    //    {
    //        var res = await _hub.LoadMessages(tokenSource.Token, 50);
    //        return res.Select(message => new TextMessageViewModel(message.DateTime, new User(message.UserName), message.Text, message.UserName == _user.Name, true));
    //    }
    ...
    //        logger.Debug("Disposing. TextMessageViewModel sended...");
    //        _hub.Dispose();
